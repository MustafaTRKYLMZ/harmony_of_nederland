...
export interface ApiDonationDonation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    donationType: Schema.Attribute.Enumeration<
    ...
    donorAddress: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    donorCompany: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    taxReceiptRequired: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['cultural', 'educational', 'social', 'workshop', 'other']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    collaborationAreas: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    partnerType: Schema.Attribute.Enumeration<
      ['cultural', 'educational', 'governmental', 'nonprofit', 'commercial']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiVolunteerVolunteer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    preferredTasks: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volunteerStatus: Schema.Attribute.Enumeration<
      ['active', 'inactive', 'pending']
    >;
    volunteerType: Schema.Attribute.Enumeration<
      ['regular', 'occasional', 'student', 'professional']
    >;
  };
}
